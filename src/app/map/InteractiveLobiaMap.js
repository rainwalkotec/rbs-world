...
const locations = [
  {
    ...
    emblem: {
      src: "/images/heraldry/depol-arms.png",
      title: "Герб Деполя",
      note: "Геральдический знак столицы Лобии и королевской власти Деполя",
    },
  },
  {
    id: "bukhin",
  ...
  },
  {
    id: "dashfurt",
    name: "Дашфурт",
    type: "Древесный форт Лесного Народца",
    x: 76.0,
    y: 38.5,
    danger: "Священный лес / вассал Лобии",
    description:
      "Центральный город Лесного Народца, присягнувший Влоду III Тихому в 828 году и ставший частью северо-восточных владений Лобии.",
    details:
      "Дашфурт вплетён в чащи Шерр-Метта: древесная архитектура, Ховридское посольство, пушнина, медь, сталь и огромная сталеварня с трубами выше девяностометровых дубов.",
  },
  {
    id: "chekhgart",
    name: "Чехгарт",
    ...
    landscape: {
      src: "/images/landscapes/lobian-ravnina.jpg",
      title: "Равнины и старые дороги Чехгарта",
      note: "Подходит для: Чехгарт, место посвящения Короля Розы и окрестные равнины",
    },
    emblem: {
      src: "/images/heraldry/chekhgart-arms.png",
      title: "Герб Чехгарта",
      note: "Геральдический знак города королевской памяти и старых посвящений",
    },
  },
  {
    id: "arrawdorf",
    ...
    x: 25.9,
    y: 60.2,
    danger: "Торговое перепутье / малая автономия",
    description:
      "Открытое многонациональное поселение Лесного Народца между Млоскаром и Грязанью, присоединённое к Лобии в 556 году.",
    details:
      "Арравдорф живёт караванами, лобийской сталью, керамским фарфором и памятью об Арраввальде — огромном лесу, от которого после 350 лет правления людей остались лишь рощи.",
    landscape: {
      src: "/images/landscapes/lobian-ravnina.jpg",
      title: "Западные равнины Арравдорфа",
      note: "Подходит для: Арравдорф, торговое перепутье и остатки Арраввальда",
    },
  },
  {
    id: "ralfberg",
    ...
    landscape: {
      src: "/images/landscapes/lobian-ravnina.jpg",
      title: "Удалённые равнины Ральфберга",
      note: "Подходит для: Ральфберг, юго-западные окраины и старые дороги",
    },
  },
  {
    id: "pogan",
  ...
  },
  {
    ...
    x: 34.0,
    y: 72.6,
    danger: "Жара / гарнизон / гонки",
    description:
      "Большое засушливое поселение на юго-западных границах Лобии, известное степями, крепостью, мотокаретами и жаркими состязаниями.",
    details:
      "В Грязани стоит действующая крепость с крупнейшим гарнизоном королевства, огромный гоночный трек и мастерские катательных и летательных аппаратов. Здесь живут дальние родственники Бертрана.",
    emblem: {
      src: "/images/heraldry/gryazan-arms.png",
      title: "Герб Грязани",
      note: "Геральдический знак юго-западного города-крепости, гонок и мотокарет",
    },
  },
  {
    id: "zaytun",
    ...
    x: 31.5,
    y: 29.7,
    danger: "Проходимое место / человеческая преступность",
    description:
      "Небольшая болотная деревня на дороге из Москии к Млоскару, известная едальнями, пекарнями и трактирными остановками путников.",
    details:
      "Раньше Зайтун был населён низшими амфибианцами, но теперь состоит в основном из высших. Небольшая человеческая диаспора снискала плохую репутацию из-за дебошей, воровства и хулиганства.",
  },
  {
    id: "kru-zha",
    name: "Кру-Жа",
    type: "Столица Высших Амфибианцев",
    x: 27.7,
    y: 44.2,
    danger: "Автономия / притеснение чужаков",
    description:
      "Главный город Высших Амфибианцев в Лобии, стоящий на малых озёрах и болотах. Здесь решения принадлежат амфибианским посадникам.",
    details:
      "Кру-Жа славится разливным пивом «Торф» и «Трясина», дипломатической академией АГАМО и прямой службой вождя Высших Амфибийцев Королю и Деполю.",
  },
  {
    id: "keram",
    name: "Керам",
    ...
    landscape: {
      src: "/images/landscapes/lobian-ravnina.jpg",
      title: "Поля и дальние холмы Керама",
      note: "Подходит для: Керам, земли за Большой Ворлгой и амфибианские окраины",
    },
  },
  {
    id: "yuzhny",
  ...
  },
  {
    id: "aquapills",
    name: "Аквапилс",
    type: "Пограничное поселение Бисмии",
    x: 66.6,
    y: 20.6,
    danger: "Закрытая граница / тёмная магия",
    description:
      "Небольшое поселение бисмийцев на границе с Лобией, через которое проходят слухи из закрытого Королевства Бисмия.",
    details:
      "В Аквапилсе живут тёмные люди, немного амфибианцев, дежурит гвардия из Букина и бывает делегация Ховридской Коллегии, следящая за применением тёмной магии.",
  },
  {
    id: "valuyan",
    name: "Валуян",
