...
const locations = [
...

  {
    ...
    type: "Северная военная слобода",
    x: 44.8,
    y: 9.8,
    danger: "Военная автономия / северные ворота",
    description:
      "Милитаризированные лесные территории к северу от Озер-Тара, выросшие из казарм наёмных компаний, охранявших северные ворота священной земли.",
    details:
      "В 660-х годах епископы Озер-Тара нанимали вооружённые немецкие компании, а в 740-х, после опустения Озер-Тара и нехватки церковных денег, многие наёмники остались и основали автономную буферную зону. Прусские роты славятся мощным оружием и самоходными повозками.",
  },
  {
    id: "valuyan",
    name: "Валуян",
